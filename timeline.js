...
(function() {
  var $, delay, nextOffset, startAnimatic;
  ...
  window.drawTimeline = function() {
    var chunk_div, clearDiv, delete_link, frame, frame_name, index, offset, origWidth, resizeEnable, resizeStartX, resizing, scale, select, select_clone, timeline, timeline_container, _i, _len;
    scale = .1;
    resizeEnable = false;
    resizing = null;
    origWidth = null;
